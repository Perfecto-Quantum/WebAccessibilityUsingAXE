...
public class GoogleStepDefs {
	...
	@Then("^I select \"([^\"]*)\" from search results$")
	public void select_from_search_results(String result) throws Throwable {
		QAFExtendedWebElement searchResultElement =
				new QAFExtendedWebElement(By.partialLinkText(result));
		searchResultElement.verifyPresent(result);
