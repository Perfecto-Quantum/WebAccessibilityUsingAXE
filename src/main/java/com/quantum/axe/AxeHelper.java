...
public class AxeHelper {
  ...
  static {
    //CME Added to support Quantum integration with Axe. Put property into application .properties
    String axeres = ConfigurationUtils.getBaseBundle().getPropertyValue("env.axeresources");
